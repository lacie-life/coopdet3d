...
def visualize_feature_map_cam(feature):
    ...
    plt.savefig(str('/home/bevfusion/viz_tumtraf_featmap/features/camera/feature_map_'+str(cam_plot_idx)+'.png'), bbox_inches='tight')

def visualize_feature_map_lidar(feature):
    global lid_plot_idx
    lid_plot_idx += 1
    feature = feature.cpu().squeeze(0)
    gray_scale = torch.sum(feature,0)
    gray_scale = gray_scale / feature.shape[0]
    plt.imshow(gray_scale)
    plt.savefig(str('/home/bevfusion/viz_tumtraf_featmap/features/lidar/feature_map_'+str(lid_plot_idx)+'.png'), bbox_inches='tight')
